'''
This Simulator subclass is tailored for use for the Rice-Lin potential, created by Chris Liepold. Extends LJ theory to 3- and 4-body potential using empirical fit function. see paper for details
'''
