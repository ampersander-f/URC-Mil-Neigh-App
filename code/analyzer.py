...
class Analyzer:
	...
	def parse_file(self, file):
		...
		for line in file:
			...
			#resets time_step_holder and appends its data to simulation_holder
			if reset:					
	...
	def find_nearest_neighbors(self, positions, next_nearest):
		...
		#generate a Voronoi diagram of the particles
		...
		#repeats after inverting the Voronoi list
	...
	def perform_analysis(self, file_name, number_of_molecules):
		...
		for ts in gen_fun:
			...
			for sensor in self.pressure_sensor_list:
				...
				sensor.calc_pressure(particle_dict, area)
