'''
An instance of this class will run a simulation (or many) with a given set of parameters, until completion. Runner file will send the results of the simulation (the .xyz file) to the analyzer class instance to calculate the pressure.

Extended into subclasses for different atomic potentials, this is just for a very basic Lennard-Jones potential.
'''
