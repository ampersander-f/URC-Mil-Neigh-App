'''
Subclass of PressureSensor, tailored to use the Rice-Lin potential function instead. used in the 3-body constants, with the gaussian fitting function added in
'''
...
class PressureSensorRL(PressureSensor):
	...
	'''as in parent, calculates the potential (integral of force)'''
